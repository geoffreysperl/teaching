...
@media (max-width: 768px) {
  ...
  .journal-image, .audio-analysis {
    width: 100%;
  }
}RetryGSI think we can take the gallery out from the top.EditI'll restructure the page without the gallery at the top. Here's the revised version:
markdownCopy---
layout: page
title: Roleplaying & Literacy
description: Using tabletop roleplaying game techniques to develop literacy skills
